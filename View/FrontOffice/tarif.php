...
-->
    ...
    <body>
            ...
            <main>
                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse" id="navbarNav">
                            <ul class="navbar-nav ms-lg-auto">
                                <li class="nav-item">
                                    <a class="nav-link click-scroll" href="#section_1">Tozeur</a>
                                </li>
        
                                <li class="nav-item">
                                    <a class="nav-link click-scroll" href="#section_2">Djerba</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link click-scroll" href="#section_3">El Jem</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link click-scroll" href="#section_4">Sidi bou said</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link click-scroll" href="#section_5">Carthage</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link click-scroll" href="#section_6">Tunis</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link click-scroll" href="#section_7">Douz</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link click-scroll" href="#section_8">Dougga</a>
                                </li>
                                <li class="nav-item">
                            ...
                            <div class="ms-lg-3">
                                <a class="btn custom-btn custom-border-btn" href="index.php">
                                    Go Back
                ...
                <!--info tozeur-->
                <section class="menu-section section-padding" id="section_1">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-12">
                                <div class="menu-block-wrap">
                                    <div class="text-center mb-4 pb-lg-2">
                                        ...
                                        <img src="images/tozeur.jpg" class="tozeur-image">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-12">
                                <div class="menu-block-wrap">
                                    <div class="text-center mb-4 pb-lg-2">
                                        ...
                                        <img src="images/Djerba.jpg" class="tozeur-image">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-12">
                                <div class="menu-block-wrap">
                                    <div class="text-center mb-4 pb-lg-2">
                                        ...
                                        <img src="images/jem.jpg" class="tozeur-image">
                                </div>
                            </div>
                ...
                <!--info sidi bou said-->
                <section class="menu-section section-padding" id="section_4">
                    <div class="container">
                        <div class="row">
                                    ...
                                    <div class="menu-block">
                                        <div class="d-flex">
                                            <ul>
                                                ...
                                                <li><h6>  Le Café des Délices : pour un déjeuner avec vue.</h6></li>
                                                <li><h6>  Dar Zarrouk : un restaurant traditionnel avec une terrasse agréable et des plats locaux.</h6></li>
                                            </ul>
                            ...
                            <div class="col-lg-6 col-12">
                                <div class="menu-block-wrap">
                                    <div class="text-center mb-4 pb-lg-2">
                                        ...
                                        <img src="images/sidi_bou_said.jpg" class="tozeur-image">
                                </div>
                            </div>
                ...
                <!--info carthage-->
                <section class="menu-section section-padding" id="section_5">
                    <div class="container">
                        <div class="row">
                                    ...
                                    <div class="menu-block">
                                        <div class="d-flex">
                                            <ul>
                                                ...
                                                <li><h6> Le couscous : généralement servi avec de l'agneau, du poulet, ou du poisson, accompagné de légumes et d'une sauce épicée.</h6></li>
                                                <li><h6>Le mechoui : un agneau rôti à la broche, délicatement épicé et souvent servi avec du pain maison.</h6></li>
                                                <li><h6>Le fricassé : un sandwich frit traditionnel, garni de thon, d’œufs durs, de pommes de terre et de harissa</h6></li>
                                            </ul>
                ...
                <!--info douz-->
                <section class="menu-section section-padding" id="section_7">
                    <div class="container">
                        <div class="row">
                                ...
                                <div class="menu-block-wrap">
                                    ...
                                    <div class="menu-block my-4">
                                        <div class="d-flex">
                                            ...
                                            <ul>
                                                <li><h6>Balade à dos de dromadaire dans le désert : Montez à dos de dromadaire et partez pour une traversée des dunes dorées. Profitez du silence et de l'immensité du désert.</h6></li>
                                                <li><h6>Option alternative : Randonnée en quad ou en buggy pour les amateurs de sensations fortes.</h6></li>
                                            </ul>
                ...
                <!--info dougga-->
                <section class="menu-section section-padding" id="section_8">
                    <div class="container">
                        <div class="row">
                                    ...
                                    <div class="menu-block">
                                        <div class="d-flex">
                                            <ul>
                                                ...
                                                <li><h6>Le Capitole : Temple majestueux dédié à Jupiter, Junon et Minerve.</h6></li>
                                                <li><h6>Le Théâtre : Pouvant accueillir environ 3 500 spectateurs, encore utilisé pour des spectacles</h6></li>
                                                <li><h6>Les Thermes : Ancien lieu de détente des citoyens romains.</h6></li>
                                                <li><h6>Le Mausolée Libyco-Punique : Structure funéraire unique dans le monde romain.</h6></li>
                                                <li><h6>Le Forum et les places publiques : Centres de la vie politique et sociale.</h6></li>
                                            </ul>
                                            <span class="underline"></span>
                ...
                <!--info kairouan-->
                <section class="menu-section section-padding" id="section_9">
                    <div class="container">
                        <div class="row">
                                    ...
                                    <div class="menu-block my-4">
                                        <div class="d-flex">
                                            <ul>
                                                ...
                                                <li><h6>Les tapis traditionnels de Kairouan.</h6></li>
                                                <li><h6>Dégustation de la fameuse pâtisserie locale, le makroud (gâteau de semoule aux dattes)</h6></li>
                                            </ul>
                ...
                <!--info ain drahem et tbarka-->
                <section class="menu-section section-padding" id="section_10">
                    <div class="container">
                        <div class="row">
