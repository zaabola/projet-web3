...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if ($tableSelection === 'all') {
    $showManagementTable = true;
    $showDonationTable = true;
  } elseif ($tableSelection === 'management') {
    $showManagementTable = true;
  } elseif ($tableSelection === 'donation') {
    $showDonationTable = true;
  }
}
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
...
<head>
  ...
  <style>
    ...
    .main-content {
      max-height: 100vh;
      /* Make sure it's constrained within the viewport */
      overflow-y: auto;
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-dark" href="../pages/reclamation.php">
            ...
            <span class="nav-link-text ms-1">Orders complaints</span>
          </a>
        </li>
        <li class="nav-item">
